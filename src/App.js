  ...
  return (
    <div className="mx-16 my-8">
      <div className="flex justify-between items-center mb-5">
        <h2><span className="text-4xl">G</span><span className="text-2xl">allery</span></h2>
        <button
          className="hover:bg-red-500 text-white bg-red-600 border-0 py-1 px-3 rounded-md"
